...
function LoginCadastroEmpresa() {
    ...
    const handleSubmit = async (values) => {
        const { nome, descricao, imagem, email, senha } = values;

        const { data, error } = await supabase
            .from('empresas')
            .insert([{ nome, descricao, imagem, email, senha }]);
        ...
        <div className="container">
            ...
            >
                <Form form={form} onFinish={handleSubmit}>
                    ...
                    <Form.Item name="descricao" rules={[{ required: true, message: 'Por favor, insira a descrição da empresa' }]}>
                        <Input.TextArea placeholder="Descrição da Empresa" />
                    </Form.Item>
                    ...
                    <Button id="semconta" type="primary" htmlType="submit">Cadastrar Empresa</Button>
                </Form>
            </Modal>
        </div>
