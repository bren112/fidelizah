    ...
    return (
        <div>
            ...
            <div className="user">
                ...
                <Link to='/historico'><button  type="primary" className='historico'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-book" viewBox="0 0 16 16">
